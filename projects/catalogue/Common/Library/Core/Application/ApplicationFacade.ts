...
module SDL.Client.Application
{
	...
	{
		export function callApplicationFacade(method: string, arguments: any[], caller: ICallingApplicationData): void
		{
			...
			else
			{
				...
				var execute: {(args: any[]): any; applicationDomain?: string; applicationId?: string;} = (args: any[]): any =>
					{
