...
module SDL.Client.Application
{
	...
	function initializeApplication()
	{
		...
		if (hosted)
		{
			...
			var timeout: number = window.setTimeout(function()
			{
				timeout = null;
			...
			var host: IApplicationHost = new ApplicationHostProxyClass();
			var onUnload = () =>
				{
