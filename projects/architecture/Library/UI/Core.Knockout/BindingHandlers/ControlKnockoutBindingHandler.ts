...
module SDL.UI.Core.Knockout.BindingHandlers
{
	...
	class ControlKnockoutBindingHandler
	{
		init(element, valueAccessor, allBindingsAccessor, viewModel, bindingContext): any
		{
			var value = <IControlKnockoutBinding>ko.utils.unwrapObservable(valueAccessor()) || "";
			if (value)
			{
		...
		private static initControlBinding(element: HTMLElement, valueAccessor: any, allBindingsAccessor, viewModel, bindingContext): void
		{
			var $e = SDL.jQuery(element);
		...
		static addControlDisposalCallback(element: HTMLElement, control: Core.Controls.IControl)
		{
