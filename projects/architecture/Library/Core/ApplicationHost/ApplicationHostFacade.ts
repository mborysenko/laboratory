...
module SDL.Client.ApplicationHost.ApplicationHostFacade
{
	...
	export function setActiveApplicationEntryPoint(applicationEntryPointId: string, applicationId?: string): void
	{
		return ApplicationHost.setActiveApplicationEntryPoint(applicationEntryPointId, applicationId);
	}

	export function setApplicationEntryPointUrl(applicationEntryPointId: string, url: string, applicationId?: string, allowedDomains?: string[]): void
	{
		return ApplicationHost.setApplicationEntryPointUrl(applicationEntryPointId, url, applicationId, allowedDomains);
	}

	export function callApplicationFacade(applicationEntryPointId: string, method: string, args?: any[], callback?: (result: any) => void, applicationId?: string, allowedDomains?: string[]): void
	{
		return ApplicationHost.callApplicationFacade(applicationEntryPointId, method, args, callback, applicationId, allowedDomains);
	}
