...
<div class="__hide" id="popup-a">
    <jdoc:include type="modules" name="popup_a" style="none"/>
</div>
<div class="__hide" id="popup-b">
        ...
        <div class="lvf-grid_container __fill __lvf_scheme_blue">
            <div id="header" class="lvf-grid_row row-fluid">
                ...
                <div class="lvf-grid_cell span3 offset1 clearfix">
                    <div id="userpanel" class="lvf-user pull-right">
                        <div class="lvf-user_box __upper __horizontal">
                            <table>
                                <tr>
                                    <td>
                        ...
                        <div class="lvf-user_box __upper">
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="templates/<?php echo $this->template ?>/js/template.min.js"></script>
