...
{
    export interface IContinuousIterationObjProperties extends SDL.Client.Models.IProperties
	{
		id: string;        
        active: boolean;
        toCancel: boolean;
    ...
    class ContinuousIterationObject extends SDL.Client.Models.MarshallableObject 
    {
